...
#Software configuration
    ...
    software=(
        ...
        "anki calligra-braindump calligra-flow calligra-krita gcalcli geeqie gource gvim impressive kdegraphics-okular kdeutils-filelight libreoffice-fresh libreoffice-en-US hyphen hyphen-en hyphen-ru hunspell hunspell-en hunspell-ru mc pencil scrot syncplay thunar vlc yed"
        "ctags latex-beamer latex-pscyr python python-matplotlib python-numpy python-pygame-hg python-pyserial python-scipy python-sphinx python2-pygments texlive-core texlive-humanities texlive-langcyrillic texlive-latexextra texlive-pictures texlive-science wine"
