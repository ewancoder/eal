...
#Software configuration
    ...
    software=(
        ...
        "anki calligra-braindump calligra-flow calligra-krita geeqie gource gvim impressive kdegraphics-okular kdeutils-filelight libreoffice-fresh libreoffice-en-US hyphen hyphen-en hyphen-ru hunspell hunspell-en hunspell-ru mc scrot syncplay thunar vlc"
