...
#Software configuration
    ...
    software=(
        ...
        "ctags latex-beamer latex-pscyr mono pygmentize python python-matplotlib python-numpy python-pygame-hg python-pyserial python-scipy python-sphinx python2-pygments texlive-core texlive-humanities texlive-langcyrillic texlive-latexextra texlive-pictures texlive-science wine"
