...
#Software configuration
    ...
    software=(
        ...
        "compton cronie cv devilspie udevil dmenu dunst feh fuse git gksu gxkb jmtpfs irssi libnotify openssh p7zip rsync rxvt-unicode screen tig tilda transset-df xorg-server xorg-server-utils xorg-xinit wmii-hg unrar unclutter unzip urxvt-perls wpa_supplicant xclip zsh"
